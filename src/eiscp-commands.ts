  ...
  commands: {
    ...
    SLI: {
      ...
      values: {
        ...
        "NLSL0": { name: "tunein", description: "selects TuneIn after selecting NET" },
        "NLSL1": { name: "spotify", description: "selects Spotify after selecting NET" },
        "NLSL2": { name: "deezer", description: "selects Deezer after selecting NET" },
        "NLSL3": { name: "tidal", description: "selects Tidal after selecting NET" },
        "NLSL4": { name: "amazonmusic", description: "selects AmazonMusic after selecting NET" },
        "NLSL5": { name: "chromecast", description: "selects Chromecast after selecting NET" },
        "NLSL6": { name: "dts-play-fi", description: "selects DTS-Play-Fi after selecting NET" },
