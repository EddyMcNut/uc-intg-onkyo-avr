export const eiscpCommands = {
  commands: {
    ...
    SLI: {
      ...
      values: {
        "00": { name: "video1", description: "sets VIDEO1, VCR/DVR" },
        "01": { name: "cbl/sat", description: "sets VIDEO2, CBL/SAT" },
        "02": { name: "game", description: "sets VIDEO3, GAME/TV, GAME" },
        "03": { name: "aux", description: "sets VIDEO4, AUX1(AUX)" },
        "04": { name: "aux2", description: "sets VIDEO5, AUX2" },
        "05": { name: "pc", description: "sets VIDEO6, PC" },
        ...
        "20": { name: "tape", description: "sets TAPE(1), TV/TAPE" },
        ...
        "28": { name: "internet-radio", description: "sets INTERNET RADIO, iRadio Favorite" },
        "29": { name: "usb", description: "sets USB (subsetting of NET" },
        ...
        "2B": { name: "net", description: "sets NETWORK, NET" },
