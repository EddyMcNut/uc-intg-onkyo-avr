export const eiscpMappings = {
  ...
  value_mappings: {
    ...
    SLI: {
      ...
      usbt: { value: "2C" },
      bluetooth: { value: "2E" },
      tunein: { value: "SSNLSL0" },
      spotify: { value: "SSNLSL1" },
      deezer: { value: "SSNLSL2" },
      tidal: { value: "SSNLSL3" },
      amazonmusic: { value: "SSNLSL4" },
      chromecast: { value: "SSNLSL5" },
      "dts-play-fi": { value: "SSNLSL6" },
      airplay: { value: "SSNLSL7" },
      alexa: { value: "SSNLSL8" },
      "music-server": { value: "SSNLSL9" },
      up: { value: "UP" },
      down: { value: "DOWN" },
      query: { value: "QSTN" }
    },
