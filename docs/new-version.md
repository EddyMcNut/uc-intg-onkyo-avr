...
Version 0.8.0 is compatible with [Integration Manager](https://github.com/JackJPowell/uc-intg-manager).

## Ïnstalling a new version directly within the web configurator
